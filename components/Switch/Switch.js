...
export function Switch({ label = '', checked = false, onchange, id }) {
  ...
  const template = ({ checked }) => `
    <div class="form-check form-switch d-flex align-items-center gap-3 ps-0">
      <input class="form-check-input m3-switch ms-0" type="checkbox" role="switch" id="${finalId}" ${checked ? 'checked' : ''} data-ref="input" data-rnx-ignore="true">
